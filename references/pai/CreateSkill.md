...
**Before creating ANY skill, READ:** [SkillSystem.md](SkillSystem.md)
...
1. **Read the spec:** [SkillSystem.md](SkillSystem.md)
2. **Create directory:** `.claude/skills/SkillName/`
...
```bash
python .claude/skills/CreateSkill/resources/AnthropicSkillCreator/scripts/quick_validate.py .claude/skills/SkillName
```
